...
\begin{document}
    ...
    \subsection*{Entità e relazioni}
        \begin{center}
            \includesvg[width=0.8\textwidth, inkscapelatex=false]{immagini/dominio}
    ...
    \subsection*{Caso d'uso "processa analisi"}
        ...
        \begin{center}
            \includesvg[width=\textwidth]{immagini/classi}
            \vspace{2mm}
        ...
        \begin{center}
            \includesvg[width=0.8\textwidth]{immagini/login}
            \vspace{2mm} 
        ...
        \begin{center}
            \includesvg[width=0.9\textwidth]{immagini/selezione}
            \vspace{2mm} 
        ...
        \begin{center}
            \includesvg[width=0.9\textwidth]{immagini/analisi}
            \vspace{2mm} 
        ...
        \begin{center}
            \includesvg[width=0.4\textwidth]{immagini/download}
            \vspace{2mm} 
